...
export async function saveStatistic (info, req = null) {
    ...
    info.sysCode = info.sysCode || 'ucenter.api'
    info.sysName = info.sysName || '用户中心api主程序'
    info.clientCode = info.clientCode || 'ucenter'
    info.clientName = info.clientName || '用户&授权中心'
