/**
 * @fileOverview OAuth2.0授权的accessToken记录信息
 ...
 * @description 索引
 */
accessTokenSchema.index({insertTime: 1})
accessTokenSchema.index({updateTime: 1})
accessTokenSchema.index({accessToken: 1})
accessTokenSchema.index({clientCode: 1})
accessTokenSchema.index({userCode: 1})
accessTokenSchema.index({userCode: 1, clientCode: 1})
