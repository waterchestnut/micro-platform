...
export const getAllParamModels = (options = {}) => {
    ...
    ret.UserInfoWithToken = {
        ...ret.UserInfo,
        title: 'UserInfoWithToken',
        properties: {
            ...ret.UserInfo.properties,
            accessToken: {type: 'string'},
            expiresTime: {type: 'number'},
            refreshToken: {type: 'string'},
            privs: {type: 'array', items: {type: 'string'}}
        }
    }

    ret.ModuleFormatted = {
        ...ret.Module,
        title: 'ModuleFormatted',
        properties: {
            ...ret.Module.properties,
            clientName: {type: 'string'},
        }
    }

    ret.ModulePrivFormatted = {
        ...ret.ModulePriv,
        title: 'ModulePrivFormatted',
        properties: {
            ...ret.ModulePriv.properties,
            moduleName: {type: 'string'},
            clientName: {type: 'string'},
        }
    }

    ret.PageConfigFormatted = {
        ...ret.PageConfig,
        title: 'PageConfigFormatted',
        properties: {
            ...ret.PageConfig.properties,
            clientName: {type: 'string'},
        }
    }
