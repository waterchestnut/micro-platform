...
export async function saveStatistic (info, req = null) {
    ...
    info.sysCode = info.sysCode || 'statistic.api'
    info.sysName = info.sysName || '统计服务api主程序'
    info.clientCode = info.clientCode || 'statistic'
    info.clientName = info.clientName || '统计服务'
