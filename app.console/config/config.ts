...
export default defineConfig({
  ...
  openAPI: [
    {
      requestLibPath: 'import {ResponseStructure, appRequest as request} from \'@/services/request\';',
      schemaPath: 'http://localhost:12003/documentation/json',
      projectName: 'app-base',
      mock: true,
      namespace: 'APPAPI'
    },
  ],
