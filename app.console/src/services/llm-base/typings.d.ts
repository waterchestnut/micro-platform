declare namespace LLMAPI {
  ...
  type Conversation = {
    ...
    channelGroup?: string;
    /** 会话类型 */
    conversationType?: 'chat' | 'agentTask' | 'u2u' | 'm2m';
    /** 大模型配置节点 */
    llmModel?: string;
    /** 会话所属人 */
    operator?: Record<string, any>;
  ...
  type fullDefinitionModels = {
    ...
    /** ThoughtChain */
    ThoughtChain?: {
      thoughtChainCode?: string;
      progress?: 'waiting' | 'processing' | 'finish' | 'error' | 'abort';
      title?: string;
      description?: string;
  ...
  type fullEnumModels = {
    ...
    ConversationTypeEnum?: { chat?: string; agentTask?: string; u2u?: string; m2m?: string };
    /** MessageProgressEnum */
    MessageProgressEnum?: {
      waiting?: string;
      processing?: string;
  ...
  type getCoreGrpcSkillIpmiDetailParams = {
    skillCode: string;
  };

  type getCoreGrpcSkillMyDetailParams = {
    skillCode: string;
  };
