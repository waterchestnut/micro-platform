...
export default defineConfig({
  ...
  openAPI: [
    {
      requestLibPath: 'import {ResponseStructure, ucenterRequest as request} from \'@/services/request\';',
      schemaPath: 'http://localhost:12001/documentation/json',
      projectName: 'ucenter-base',
      mock: true,
