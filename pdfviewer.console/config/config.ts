...
export default defineConfig({
  ...
  openAPI: [
    ...
    {
      requestLibPath: 'import {ResponseStructure, resourceRequest as request} from \'@/services/request\';',
      schemaPath: 'http://localhost:12007/documentation/json',
      projectName: 'resource-base',
      mock: true,
