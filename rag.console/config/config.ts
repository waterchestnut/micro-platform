...
export default defineConfig({
  ...
  openAPI: [
    {
      requestLibPath: 'import {ResponseStructure, ragRequest as request} from \'@/services/request\';',
      schemaPath: 'http://localhost:12013/documentation/json',
      projectName: 'rag-base',
      mock: true,
      namespace: 'RAGAPI'
    },
  ],
