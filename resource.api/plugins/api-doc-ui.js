...
export default fp(async (fastify) => {
    ...
    const tags=[
        ...
        {name: 'res', description: '资源基础API'},
        {name: 'res-ipmi', description: '资源管理相关的API'},
        {name: 'res-my', description: '当前用户的资源相关的API'},
        {name: 'literature', description: '文献阅读相关的API'},
        {name: 'resource-search', description: '资源检索相关的API'},
    ]
    ...
    fastify.register(swagger, {
        ...
        openapi: {
            ...
            servers: [
                ...
                {
                    url: 'https://apisix.local/resource',
                    description: '测试环境'
                }
            ],
            tags,
