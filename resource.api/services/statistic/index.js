...
export async function saveStatistic (info, req = null) {
    ...
    info.sysCode = info.sysCode || 'resource.api'
    info.sysName = info.sysName || '资源服务api主程序'
    info.clientCode = info.clientCode || 'resource'
    info.clientName = info.clientName || '资源服务'
