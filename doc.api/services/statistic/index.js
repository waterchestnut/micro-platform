...
export async function saveStatistic (info, req = null) {
    ...
    info.sysCode = info.sysCode || 'doc.api'
    info.sysName = info.sysName || '文件服务api主程序'
    info.clientCode = info.clientCode || 'doc'
    info.clientName = info.clientName || '文件服务'
