...
export default fp(async (fastify) => {
    ...
    const tags = [
        ...
        {name: 'rag', description: 'RAG基础API'},
        {name: 'rag-ipmi', description: '知识库管理相关的API'},
        {name: 'rag-my', description: '当前用户的知识库相关的API'},
        {name: 'public-bin', description: '公开调用的api'},
        {name: 'rag-search', description: '知识库召回相关的API'},
    ]
    ...
    fastify.register(swagger, {
        ...
        openapi: {
            ...
            info: {
                title: '知识库服务',
                description: '微平台知识库服务端',
                version: '1.1.0'
            },
            servers: [
                {
                    url: 'http://localhost:12013',
                    description: '开发环境'
                },
                {
                    url: 'https://apisix.local/rag',
                    description: '测试环境'
                }
            ],
            tags,
