...
export async function addWidget(curUserInfo, widget) {
    ...
    let newWidgetInfo = {
        ...
        pcRedirectUrl: widget.pcRedirectUrl,
        miniRedirectUrl: widget.miniRedirectUrl,
...
export async function updateWidget(curUserInfo, widgetCode, newWidget) {
    ...
    let widget = {
        ...
        pcRedirectUrl: newWidget.pcRedirectUrl,
        miniRedirectUrl: newWidget.miniRedirectUrl,
