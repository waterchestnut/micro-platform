...
export async function saveStatistic (info, req = null) {
    ...
    info.sysCode = info.sysCode || 'llm.api'
    info.sysName = info.sysName || '大模型服务api主程序'
    info.clientCode = info.clientCode || 'llm'
    info.clientName = info.clientName || '大模型服务'
