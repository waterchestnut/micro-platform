...
export default defineConfig({
  ...
  openAPI: [
    {
      requestLibPath: 'import {ResponseStructure, statisticRequest as request} from \'@/services/request\';',
      schemaPath: 'http://localhost:12010/documentation/json',
      projectName: 'statistic-base',
      mock: true,
  ...
  define: {
    ...
    /*日志中心接口地址*/
    STATISTIC_API_BASE: process.env.STATISTIC_API_BASE || 'http://localhost:12010',
  },
});
